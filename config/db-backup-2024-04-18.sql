...
DROP TABLE IF EXISTS area_legal;

CREATE TABLE `area_legal` (
  `id_legal` int(11) NOT NULL,
  `tipo_registro` int(11) NOT NULL,
  `tipo_tenencia` int(11) NOT NULL,
  `tomo` int(11) NOT NULL,
  `folio` int(11) NOT NULL,
  `nro_area` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;




DROP TABLE IF EXISTS area_tecnica;

CREATE TABLE `area_tecnica` (
  `id_tecnica` int(11) NOT NULL,
  `medida_vivienda` int(11) NOT NULL,
...
DROP TABLE IF EXISTS cita_catastral;

CREATE TABLE `cita_catastral` (
  `id_cita` int(11) NOT NULL,
  `id_solicitante` int(11) NOT NULL,
  `dia_cita` date NOT NULL,
  `monto_cita` float NOT NULL,
  `doc_propiedad` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ciudades` (
  `id_ciudad` bigint(12) NOT NULL AUTO_INCREMENT,
  `id_estado` bigint(12) NOT NULL,
...
("204","11","San Juan de Los Morros","S"),
...
CREATE TABLE `direccion` (
  `id_direccion` bigint(12) NOT NULL,
  `id_estado_cxv` bigint(12) NOT NULL,
  `id_ciudad_cxv` bigint(12) NOT NULL,
  `id_municipio_cxv` bigint(12) NOT NULL,
  `id_parroquia_cxv` bigint(12) NOT NULL,
  PRIMARY KEY (`id_direccion`),
  KEY `id_estado_cxv` (`id_estado_cxv`),
  KEY `id_ciudad_cxv` (`id_ciudad_cxv`),
  KEY `id_municipio_cxv` (`id_municipio_cxv`),
  KEY `id_parroquia_cxv` (`id_parroquia_cxv`),
  CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`id_estado_cxv`) REFERENCES `estados` (`id_estado`),
  CONSTRAINT `direccion_ibfk_2` FOREIGN KEY (`id_municipio_cxv`) REFERENCES `municipios` (`id_municipio`),
  CONSTRAINT `direccion_ibfk_3` FOREIGN KEY (`id_parroquia_cxv`) REFERENCES `parroquias` (`id_parroquia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `dolar` (
  `id_dolar` int(11) NOT NULL AUTO_INCREMENT,
  `dia` date NOT NULL,
  `hora` time NOT NULL,
  `igual` float NOT NULL,
  `estado` int(11) NOT NULL,
  PRIMARY KEY (`id_dolar`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO dolar VALUES("6","2024-04-15","10:18:13","42","1");
...
CREATE TABLE `estados` (
  `id_estado` bigint(12) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `municipios` (
  `id_municipio` bigint(12) NOT NULL AUTO_INCREMENT,
  `id_estado` bigint(12) NOT NULL,
...
DROP TABLE IF EXISTS pago_solvencia;

CREATE TABLE `pago_solvencia` (
  `id_pago` int(11) NOT NULL,
  `id_consejo_comunal` int(11) NOT NULL,
  `solvencia_monto` int(11) NOT NULL,
  `estado_solvencia` int(11) NOT NULL,
  `id_solicitante` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `parroquias` (
  `id_parroquia` bigint(12) NOT NULL AUTO_INCREMENT,
  `id_municipio` bigint(12) NOT NULL,
...
CREATE TABLE `pregunta_seguridad` (
  ...
  `repuesta_1` varchar(255) NOT NULL,
  `pregunta_2` int(11) NOT NULL,
  `repuesta_2` varchar(255) NOT NULL,
  `pregunta_3` int(11) NOT NULL,
  `repuesta_3` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
