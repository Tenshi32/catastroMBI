...
<body>
  ...
  <div class="card card-primary m-5">
    <div class="card-header">
      <h1 class="card-title text-lg">Solicitud de Obtencio de Copias Certificadas</h1>
    </div>
    <span class="m-3 text-danger">Campos Obligatorios (*)</span>

    <form method="post" id="SoliOcc" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <input type="hidden" name="RegistrarCita" id="RegistrarCita">
          <input type="hidden" name="tipo_solicitud" id="tipo_solicitud" value="6">
...
<script src="../js/Validacion_SOCC.js"></script>
