          ...
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-3 mt-md-4">
                <form action="" method="post" id="TogglePasswd">
                  ...
                  <div class="form-group">
                    <label class="form-label" for="type">Contraseña Nueva</label>

                    <input type="text" name="PasswdNew" id="PasswdNew" class="form-control bg-dark">
                  </div>
                  <br>
                  <div class="form-group">
                    <label class="form-label" for="type">Confirmar Contraseña</label>

                    <input type="text" name="PasswdNewConfirm" id="PasswdNewConfirm" class="form-control bg-dark">
                  </div>
                  <br>
              </div>

              <input type="hidden" name="TogglePasswd" id="TogglePasswd">
...
<script src="../../js/Validacion_TogglePasswd.js"></script>
