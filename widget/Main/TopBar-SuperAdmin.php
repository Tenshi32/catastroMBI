    ...
    <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <?php 
          $notificacion->NotificacionSAdmin($usuario["id_usuario"]);
          ?>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu mb-1">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="consul/citas/consul_cita.php" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="consul/citas/consul_soli.php" class="nav-link">
            ...
            <li class="nav-item menu mb-1">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="proces/RTT/consul_rtt.php" class="nav-link">
                    <i class="bi bi-inboxes nav-icon"></i>
            ...
            <li class="nav-item menu mb-1">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="servic/AuditoriaUsuario.php" class="nav-link">
                    <i class="bi bi-people nav-icon"></i>
                    <p>Auditoria de Usuario</p>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="carga.php" class="nav-link">
                    ...
                    <p>Importación y Exportación de BD</p>
                  </a>
                </li>
              </ul>
            </li>
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="small-box bg-blue elevation-5">
                <div class="inner">
                  <h5 class="m-4">Tasa del Dolar y Euro actuales</h5>
                  <div class="row">

                    <div class="col">
                      <div class="btn btn-block btn-warning text-light">
                        <i class="fa fa-euro-sign"></i> <strong> 1 </strong> EUR =
                        <?php echo $_SESSION["tasa"]["euro"]; ?>Bs.
                      </div>
                    </div>

                    <div class="col">
                      <div class="btn btn-block btn-warning text-light">
                        <i class="fa fa-dollar-sign"></i> <strong> 1 </strong> USD =
                        <?php echo $_SESSION["tasa"]["dolar"]; ?>Bs.
                      </div>
                    </div>
