...
<body>
    ...
    <div class="card card-primary m-5">
        <div class="card-header">
            <h1 class="card-title text-lg">Solicitud de Regulación de Tenencia de Tierra</h1>
        </div>
        <span class="m-3 text-danger">Campos Obligatorios (*)</span>

        <form method="post" id="SoliRtt" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <hr>
                <p><strong>Datos de la Solicitud de Regulación de Tenencia de Tierra</strong></p>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="inmueble" id="inmueble" class="form-control select2 select2-danger"
                                ...
                                $select->DatosInmueblePropietario($usuario['id_usuario'], 4);
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="Propiedad_Documento"
                                        name="Propiedad_Documento" accept=".pdf">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="icheck-primary d-inline mr-2">
                                        <input type="radio" id="Concubino" name="estado_civil" value="Concubino(a)">
                                        <label for="Concubino">
                                            Concubino(a)
                                        </label>
                                    </div>
                ...
                <input type="hidden" id="SoliRTT" name="SoliRTT">
                <input type="hidden" name="tipo_solicitud" id="tipo_solicitud" value="7">
                ...
                <div id="UnionHechos" style="display: none;">
                    <hr>
                    <p><strong>Datos de Acta de Union Estable de Hechos</strong></p>
                    <div class="row">

                        <div class="col">
                            <div class="form-group">
                                <label>*Folio</label>
                                <input type="text" class="form-control" id="folio_UH" name="folio_UH">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label>*Nº de Acta</label>
                                <input type="text" class="form-control" id="n_acta_UH" name="n_acta_UH">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label>*Fecha del Acta</label>
                                <input type="text" class="form-control" id="fecha_acta_UH" name="fecha_acta_UH">
                            </div>
                        </div>

                        <div class="col">
                            <div class="form-group">
                                <label>*Año de Union</label>
                                <input type="text" class="form-control" id="anno_union" name="anno_union">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea name="descripcion_DS" id="descripcion_DS" rows="4"
