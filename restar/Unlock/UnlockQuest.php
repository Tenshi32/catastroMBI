          ...
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-3 mt-md-4">
                <form action="" method="post" id="UnlockQuest">
                  ...
                  <input type="hidden" name="usuario" id="usuario" value="<?php echo $_SESSION["unlock"]["usuario"] ?>">
              ...
              <input type="hidden" name="UnlockQuest" id="UnlockQuest">
...
<script src="../../js/Validacion_UnlockQuest.js"></script>
