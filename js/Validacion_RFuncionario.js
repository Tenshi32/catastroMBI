  ...
  $.validator.setDefaults({
    submitHandler: function () {
      const RFuncionario = {
        ...
        UrlReturn: "../consul/Perfiles/FuncionarioPerfiles.php",
        Formulario: document.getElementById("regis_funcionario"),
      };

      methodSend(RFuncionario);
    },
  });
  $("#regis_funcionario").validate({
    //Reglas/Validaciones
    rules: {
      //Datos Personales
      cedula: {
